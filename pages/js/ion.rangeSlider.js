...
;(function(factory) {
    ...
    IonRangeSlider.prototype = {
         ...
         */
        append: function () {
            var container_php = '<span class="irs js-irs-' + this.plugin_count + ' ' + this.options.extra_classes + '"></span>';
            this.$cache.input.before(container_php);
            this.$cache.input.prop("readonly", true);
            this.$cache.cont = this.$cache.input.prev();
            this.result.slider = this.$cache.cont;

            this.$cache.cont.php(base_php);
            ...
            if (this.options.type === "single") {
                this.$cache.cont.append(single_php);
                ...
                this.$cache.cont.append(double_php);
        ...
        appendDisableMask: function () {
            this.$cache.cont.append(disable_php);
        ...
        appendGrid: function () {
            ...
            for (i = 0; i < big_num + 1; i++) {
                ...
                for (z = 1; z <= local_small_max; z++) {
                    ...
                    php += '<span class="irs-grid-pol small" style="left: ' + small_w + '%"></span>';
                }

                php += '<span class="irs-grid-pol" style="left: ' + big_w + '%"></span>';
                ...
                php += '<span class="irs-grid-text js-grid-text-' + i + '" style="left: ' + big_w + '%">' + result + '</span>';
            }
